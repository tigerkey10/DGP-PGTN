...
if __name__ == '__main__':
    ...
    parser_u.add_argument('--num_channels', type=int, default=2,
                        help='number of channels')

    args_u = parser_u.parse_args()
    print('args_u:',args_u)
    num_channels_u = args_u.num_channels
    ...
    parser_v.add_argument('--num_channels', type=int, default=2,
                        help='number of channels')
    args_v = parser_v.parse_args()
    print('args_v:',args_v)
    num_channels_v = args_v.num_channels
    ...
    result = np.load('data/10000newresult.npy')
