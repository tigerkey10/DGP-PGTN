...
#### Statistics of gene and disease heterogeneous networks (Disease and gene heterogeneous networks are based on five data resources, including HumanNet [9], Human Phenotype Ontology (HPO), Gene Ontology (GO), Disease Ontology (DO) and DisGeNet)
